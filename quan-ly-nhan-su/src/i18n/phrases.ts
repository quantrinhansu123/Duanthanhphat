...
export const PHRASES: Record<string, string> = {
  ...
  // ---- Nhật ký hàn (cột / nút / trạng thái) ----
  "Ngày thực hiện": "Execution date",
  "Người trực tiếp hàn": "Welder",
  "Mã mối hàn": "Weld code",
  "Chờ thí nghiệm": "Awaiting test",
  "Không thí nghiệm": "No test",
  "Chưa liên kết GPS": "GPS not linked",
  "Chưa gán máy": "No machine assigned",
  "Chưa ghi chứng chỉ sử dụng": "Certificate not recorded",
  "Chưa ghi nguyên nhân": "Reason not recorded",
  "Tải mẫu Excel": "Download Excel template",
  "Tải Excel lên": "Upload Excel",
  "Xuất Excel": "Export Excel",
  "Đang tạo Excel…": "Generating Excel…",
  "Đang nhập…": "Importing…",
  "Đồng bộ mã mối hàn": "Sync weld codes",
  "Đồng bộ mã mối hàn theo bộ lọc hiện tại": "Sync weld codes for the current filter",
  "Đang đồng bộ…": "Syncing…",
  "Bắt đầu đồng bộ…": "Starting sync…",
  "Mối liên kết": "Linked weld",
  "Có liên kết": "Linked",
  "Chưa liên kết": "Not linked",
  "Xóa ngày": "Clear dates",
  "Xem trên bản đồ": "View on map",
  "Sửa nhật ký hàn": "Edit welding journal",
  "Thêm nhật ký hàn": "Add welding journal entry",
  "Thêm nhật ký": "Add journal entry",
  "Bản ghi mới": "New record",
  "Bản ghi nhật ký": "Journal record",
  "Không có nhật ký hàn phù hợp với bộ lọc.": "No welding journal entries match the filters.",
  "trang": "page",
  "Máy": "Machine",
  ...
  "Tình trạng thí nghiệm": "Test status",
  "Sản xuất": "Production",
  "Thử nghiệm": "Testing",
  "Đào tạo": "Training",
  "Từ ngày": "From date",
  ...
  "Loại mối": "Weld type",
  "Chọn người trực tiếp hàn": "Select welder",
  "Chọn chứng chỉ": "Select certificate",
  "Chọn dự án": "Select project",
  "— Chọn máy thực hiện —": "— Select machine —",
  "Chưa có dữ liệu thợ hàn": "No welder data",
  "Chưa có dữ liệu dự án": "No project data",
  "Chưa có danh mục máy": "No machine catalogue",
  "Nhân sự chưa có chứng chỉ trong hồ sơ": "Personnel has no certificates on file",
  "Đủ chứng chỉ": "Certificates OK",
  "Thiếu chứng chỉ": "Missing certificate",
  "Gõ tên để tìm thợ hàn...": "Type a name to find welders...",
  "Tìm chứng chỉ...": "Search certificates...",
  "Gõ để tìm dự án...": "Type to find projects...",
  "Tìm máy theo mã hoặc tên...": "Search machines by code or name...",
  "Tìm mã mối hàn...": "Search weld codes...",
  "Báo cáo máy sẽ tự cộng mối hàn theo lựa chọn này.": "Machine reports will count welds from this selection.",
