...
export const PHRASES: Record<string, string> = {
  ...
  "Hệ thống Quản lý hàn ray": "Rail Welding Management System",
  "Hệ thống Quản lý Vận hành & Nhân sự": "Rail Welding Management System",
  ...
  "Chứng chỉ quản lý chất lượng": "Quality Management Certificates",
